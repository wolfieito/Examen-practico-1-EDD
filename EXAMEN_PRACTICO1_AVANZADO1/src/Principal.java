...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        String adivina;
        char let;
        int numOportunidades, letAcertadas = 0, noAcertoLetra = -1;
                ...
                while (ganaPierde != true) {
                    ...
                    if (adivinaoNo == 0) {
                        ...
                        for (int j = 0; j < letras.length; j++) {
                            if (letAcertadas == letras[numAleatorio].length) {
                                ganaPierde = true;
                                System.out.println("Felicidades, ganaste");
                            }
                    ...
                    if (noAcertoLetra > 0 && numOportunidades > 0) {
                        numOportunidades--;
        ...
        if (numAleatorio == 3) {
            ...
            for (int i = 0; i < letras.length; i++) {
                while (ganaPierde != true) {
                    ...
                    if (noAcertoLetra > 0 && numOportunidades > 0 && ganaPierde == false) {
                        numOportunidades--;
                        System.out.println("Tienes " + numOportunidades + " oportunidades");
                    }
                    if (numOportunidades == 0) {
